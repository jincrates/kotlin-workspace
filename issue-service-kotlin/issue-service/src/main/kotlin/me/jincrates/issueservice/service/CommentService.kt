...
import me.jincrates.issueservice.domain.CommentRepository
import me.jincrates.issueservice.domain.IssueRepository
import me.jincrates.issueservice.exception.NotFoundException
import me.jincrates.issueservice.model.CommentRequest
import me.jincrates.issueservice.model.CommentResponse
import me.jincrates.issueservice.model.toResponse
...
class CommentService (
    ...
    fun delete(issueId: Long, id: Long, userId: Long) {
        ...
        commentRepository.findByIdAndUserId(id, userId)?.let{comment ->
            issue.comments.remove(comment)  //MutableList의 remove
        }
    }
}